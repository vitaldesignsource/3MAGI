...
import { isEditModeEnabled, isSelectionModeEnabled, isInsideEditorUi, ACTIONABLE_SELECTOR, EDIT_TARGET_SELECTOR, getEditId } from "./constants/selectors.js";
...
function updateTypeTooltip() {
	...
	if (!isEditModeEnabled() || isSelectionModeEnabled() || suppressTypeTooltipUntilMove || getIsDragging()) {
		hideTypeTooltip();
		return;
	}
