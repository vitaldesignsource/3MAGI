...
export default {
    ...
    groups: [
        ...
        { key: 'egyptian', label: 'The Two Lands', blurb: 'Nine gods of Heliopolis, a hidden one at Thebes, and a theology sophisticated enough to hold several creations at once without embarrassment.' },
        { key: 'levantine', label: 'Canaan and Ugarit', blurb: 'The pantheon the Bible argues with — recovered in 1929 when a farmer’s plough hit a tomb at Ras Shamra.' },
        { key: 'hellenic', label: 'Olympus', blurb: 'The best-documented family in the ancient world, and the one whose quarrels the West kept quoting.' },
        ...
        { key: 'vedic', label: 'The Vedic and Hindu Gods', blurb: 'From the hymns of the Rigveda to the living devotions of a billion people — the one pantheon in this portal that never stopped.' },
