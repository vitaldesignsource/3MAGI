...
export default {
    note: 'Classical Armenian (grabar) hall, audited. SCRIPT: all eighty-three native-script strings in the draft were run character by character through python3 unicodedata.name(); every character resolves inside the Armenian block U+0530–U+058F, with no Latin, Greek or Cyrillic look-alikes, no stray combining marks and no Armenian presentation-form ligatures. Twelve further Armenian strings introduced during this audit were verified the same way before being used. Orthography is classical throughout — yiwn, eh and oh retained where the classical spelling has them, so the forms read as they stand in the manuscripts and in the Mekhitarist editions rather than in reformed orthography. Two transliterations were corrected for internal consistency (Astuatsashunch\', and degh for the l-stroke form). Where a title is less securely attested in a single classical form — K\'nnikon for Anania\'s compendium, Akhrapatin for Amirdovlat\'s formulary, Kiprianos for Cyprian, Tesil Enovk\'ay for the Enoch apocalypse, and the John 1:1 incipit as it is customarily cited — the gloss says so, and unicodedata is understood to confirm the script and not the spelling. SOURCES: every text, manuscript, edition and scholar named has been checked and is attributed as the standard literature attributes it. Four source errors in the draft were corrected. The Irenaeus manuscript was found in December 1904 in a codex of the church of the Holy Mother of God at Erevan, not at Etchmiadzin, and was published in 1907. Feydit\'s Amulettes belongs to the Gulbenkian armenological library, not the Bazmavep series, and is an edition of a hundred and fifty-four amulets with translation rather than a descriptive study. The Seventh Vision of Daniel is dated by its translator to the late fifth century and directed against Rome, so the draft\'s attribution of it to the Arab conquests has been removed and the Ishmaelite material returned to Pseudo-Methodius, where it belongs. The Vision of Enoch the Just has been released from a flat Cilician dating that the scholarship does not support. Several quantities were tightened against their sources: the weight of the Homiliary of Mush, the size of the Matenadaran collection, the printing date of Tatevatsi. OVERSTATEMENT: claims of universality and of settled reading have been downgraded throughout — the two-stage history of the Armenian Bible, the canonical standing of Third Corinthians, the completeness of the Armenian Philo, the domestic use of the Narek, and the practical effect of the canons against sorcery. No complete Armenian version of the Testament of Solomon is known to have been published, so the Solomonic current describes a shared motif-complex and not a translated text; the Armenian magical corpus in the Matenadaran is largely unedited and is described as such. PRACTICE: everything is described historically and bibliographically — what the books contain, who copied them, how they were carried. No formula, invocation, name-sequence, preparation or procedure appears anywhere in this batch, and the alchemical theme carries an explicit statement that nothing in it is to be attempted. RESPECT: the Armenian Apostolic Church, the Mekhitarist congregations and the families who still keep a hmayil are living; folk and extra-canonical material is marked as such, neutrally; superlatives at the expense of the tradition have been struck; and the apocalyptic theme\'s inherited vocabulary for other peoples is marked as the texts\' own and not the magazine\'s.',
    themes: [
        {
            slug: 'apocrypha',
            title: 'The Apocrypha',
            ...
            paragraphs: [
                'Armenian became a written language in order to be a Christian one. Tradition places the invention of the alphabet at about 405, and its earliest witness — Koriwn\'s Life of Mashtots, composed within a generation of the event — presents the letters not as a cultural ornament but as an instrument made for a single task: to carry scripture into a tongue that had until then borrowed Syriac and Greek in order to worship. The consequences for textual transmission were peculiar and permanent. On the reconstruction the tradition itself gives, and which remains the working account though its details are still argued over, the first Armenian Bible was rendered from Syriac, and exemplars brought from Constantinople after the Council of Ephesus were then used to revise that version against the Greek; the revised text keeps traces of both operations. Armenian therefore does not descend from one of the two great eastern transmissions but sits at their junction. A second and later phase of translating, the work of what scholarship calls the Hellenophile school, the yunaban dprots\', went further still, calquing Greek word-formation and syntax with such exactitude that an Armenian sentence can often be run backwards into its Greek original almost mechanically. Early access, wide reading and an eventually mechanical fidelity: that combination is why Armenian ended up keeping books nobody else kept.',
                'The list of such books is not a curiosity but a foundation of patristic and Second Temple scholarship. Philo of Alexandria\'s Questions on Genesis and Questions on Exodus survive in Armenian in the fullest form anyone has, the Greek having come down only as fragments and catena extracts; On Providence and On Animals survive in Armenian alone. The Chronicle of Eusebius of Caesarea, and its first book above all, is preserved in Armenian and in no continuous Greek. Irenaeus of Lyons\' Demonstration of the Apostolic Preaching, lost to Greek altogether, came to light in December 1904 when Karapet Ter-Mkrtchian found it in a thirteenth-century Armenian codex belonging to the church of the Holy Mother of God at Erevan; he published it with Erwand Ter-Minassiantz in 1907, and the discovery reset the study of second-century theology. Ephrem the Syrian\'s commentary on the Diatessaron was known in its Armenian dress long before Syriac leaves of it surfaced in the twentieth century. The Armenian Alexander Romance, the Armenian Jewish War, the Armenian Timothy Aelurus: the pattern repeats. A tradition on the edge of two empires, translating hard for two centuries and then copying faithfully for many more, functions as a library of last resort.',
                'The canon itself was drawn with unusually generous margins. Third Corinthians — the exchange of letters between Paul and the Corinthian church that belongs to the Acts of Paul — went on being read, commented upon and copied in Armenian biblical manuscripts long after the Greek and Latin churches had set it aside, which is a different and more interesting fact than canonicity; it is not part of the canon as the Armenian Church now receives it, but it was never merely a curio either. Biblical codices routinely carry apocryphal matter in their outer quires: the Repose of St John, prayers, testaments, histories of the patriarchs. When Yovhannes Zohrab produced at Venice in 1805 the first critical printed Armenian Bible, he printed apocrypha alongside the canonical books, and that edition is still cited. The corpus itself was gathered by the Mekhitarists of San Lazzaro in three volumes that remain the point of departure: the uncanonical books of the Old Testament, edited by Sargis Yovsēp\'ianc\' in 1896; those of the New Testament, edited by Esayi Tayets\'i in 1898; and the uncanonical apostolic books, edited by Kerovbe Ch\'rak\'ian in 1904.',
                'What is in them repays the attention. Fourth Ezra survives in Armenian in a version so freely expanded — whole speeches added, the seer\'s argument recast — that Michael Stone, whose 1979 edition is standard, treats it as evidence for Armenian apocalyptic thought quite as much as for the lost Greek behind it; the same tradition produced the short Armenian apocryphon known as the Questions of Ezra. The Testaments of the Twelve Patriarchs exist in an Armenian recension whose shorter readings have been central to the long argument over how much of that work is Jewish and how much Christian; Stone\'s study of the Testaments manuscripts in the convent of St James in Jerusalem opened that file. Joseph and Aseneth is preserved in an Armenian version that editors treat as a primary witness. The Paralipomena of Jeremiah, the Lives of the Prophets, an abundance of patriarchal and prophetic apocrypha which Stone catalogued in 1982 — all are here. So is the Armenian Gospel of the Infancy, translated in all probability from a Syriac original, which fills the silent years with narrative and which names the magi as three brother-kings: Melkon of the Persians, Gaspar of the Indians, Baltasar of the Arabs. Abraham Terian\'s 2008 translation made it available in English at last.',
            ...
            terms: [
                ...
                {
                    native: 'Յունաբան դպրոց',
                    translit: 'yunaban dprots\'',
                    gloss: '\'Graecising school\', the Hellenophile translators of roughly the sixth to eighth centuries, who calqued Greek morphology and syntax into Armenian so exactly that their versions can be read back towards the Greek almost word by word.',
                },
                {
                ...
                },
                {
                    ...
                    gloss: '\'Repository of writings\'. Generic for a manuscript library, but used absolutely of the Mesrop Mashtots Institute of Ancient Manuscripts in Yerevan. Published counts of its holdings differ by method — around seventeen thousand manuscripts, or some twenty-three thousand items once fragments and amulet scrolls are included.',
                },
            ],
            texts: [
                {
                    title: 'The Armenian Bible (Zohrab edition)',
                    note: 'Yovhannes Zohrab, Venice: San Lazzaro, 1805 — the first critical printed Armenian Bible, with apocryphal books printed alongside the canonical text. Still cited as the working edition.',
                },
                {
                ...
                {
                    title: 'The Armenian Gospel of the Infancy',
                    note: 'Translated with introduction and commentary by Abraham Terian (Oxford, 2008); earlier French version by Paul Peeters (1914). Source of the magi as three named kings of Persia, India and Arabia.',
                },
                {
                    title: 'Irenaeus, Demonstration of the Apostolic Preaching',
                    note: 'Lost in Greek. Found in December 1904 by Karapet Ter-Mkrtchian in a thirteenth-century Armenian codex of the church of the Holy Mother of God at Erevan, and published with Erwand Ter-Minassiantz in 1907. One of the clearest cases of Armenian preserving a work entire that vanished elsewhere.',
                },
                {
                    title: 'Philo Armenus',
                    note: 'Questions on Genesis and Exodus survive in Armenian in the fullest form we have, the Greek reduced to fragments; On Providence and On Animals survive in Armenian alone. All in the exact renderings of the Hellenophile school.',
                },
            ],
        },
        {
            ...
            terms: [
                ...
                },
                {
                    native: 'դրախտ',
                    translit: 'drakht',
                    gloss: 'Garden, paradise — an Iranian loanword taken into Armenian long before Christianity and then used for Eden, so that the Armenian Eden carries a Persian park inside its name.',
                },
                {
                    native: 'մուրհակ',
                    translit: 'murhak',
            ...
            texts: [
                ...
                },
                {
                    ...
                    note: 'Extant in Syriac, Greek, Armenian, Arabic and Georgian; edited by S. E. Robinson (Society of Biblical Literature Dissertation Series, 1982). Its horarium assigns each hour of night and day to an order of creation whose praise rises at that hour.',
                },
                {
                    title: 'Ankanon girk\' hin ktakaranats\'',
                    note: 'Ed. Sargis Yovsēp\'ianc\', Venice: San Lazzaro, 1896. Where several of the Armenian Adam pieces were first printed, and still the point of first reference for the corpus.',
                },
            ],
        },
        {
            ...
            summary: 'The king who compelled demons to give their names, the ring that authorised him, and the awkward fact that in Armenia the men who copied the binding-formulae were frequently the men who had condemned them.',
            paragraphs: [
                'Solomon becomes a master of demons by a series of small exegetical steps. Scripture gives him wisdom that extends over beasts, birds and plants, and gives him the Temple; the step from wisdom over creatures to authority over spirits was taken early, and by the first century Josephus could report, in the eighth book of the Antiquities, that God had granted Solomon knowledge of the art of expelling demons, that the formulae and the exorcisms he composed were still in use, and that a certain Eleazar had drawn a demon out of a possessed man by means of a ring set with a root Solomon had prescribed, in the presence of Vespasian and his officers. The literary crystallisation of that tradition is the Greek Testament of Solomon, edited by C. C. McCown in 1922, a text of much-argued date in which an angel brings Solomon a ring, the demons are summoned one by one to build the Temple, and each in turn is compelled to give three things: its name, the harm it does, and the name of the angel or power by whom it is frustrated. That triad — name, activity, antidote — is the organising grammar of the eastern Christian demonological literature, and everything that follows in Armenian presupposes it.',
                'No complete Armenian translation of the Testament of Solomon is known to have been published, and it is worth saying so plainly, because the temptation to assume one is strong. What Armenian has is the same complex of motifs, arriving by other routes and lodged in other kinds of book: Solomon\'s seal invoked in the amulet scrolls; the demon that must declare itself before it can be dismissed; the angel set opposite each spirit as its counterweight; the ring, the seal, the binding. The specifically Armenian demon of this literature is the Al, a figure of great antiquity in the region, imagined as red and fiery, who is said to attack women in childbirth and the newborn, and against whom a large part of the surviving protective apparatus is directed. There are Armenian magical handbooks as well, of which the best known is the collection called the Six Thousand, brought to scholarly notice by James R. Russell in Bazmavep in 1989; but the honest position is that the Armenian magical corpus in the Matenadaran and in the Jerusalem and Venice collections remains for the most part unedited, and that the field is younger than the material.',
                'The operative logic, as the texts themselves present it, is not that the practitioner has power. It is that he has access to a delegated authority already established: the demon is bound because Solomon bound it, because the angel named in the formula outranks it, and above all because the name of Christ stands over the whole. Hence the characteristic form of these texts, which is narrative before it is imperative — the story of the binding is told, and the telling is understood to renew it. Hence, too, the enormous importance of writing. A formula recited passes; a formula written and carried is continuously present, which is why the Armenian protective tradition took the form of a scroll rather than a spoken charm, and why length was a virtue in it. Nothing in this needs to be reconstructed operationally to be understood, and this magazine does not reconstruct it: no formula, name-sequence or procedure is reproduced here, because the mechanism is stated in the sources themselves, and it is a mechanism of citation.',
                'Official Armenian opinion on the matter was consistent and unambiguous. The Kanonagirk\' Hayots\', the Armenian Book of Canons compiled in the early eighth century under the catholicos Yovhannes Odznetsi and issued in conjunction with the canons of his council at Dvin, legislates against sorcerers, diviners and those who resort to them, and later collections repeat the prohibition. What repetition proves is harder to say than it is often made to sound — canons are re-copied for many reasons besides disobedience — but the material evidence does complicate the picture. Eznik of Kolb had already, in the fifth century, devoted long stretches of his Refutation of the Sects to demolishing popular beliefs about spirits, fate and charms. At the far end of the medieval tradition, Grigor Tatevatsi\'s Book of Questions, completed at Tatev in 1397 and printed at Constantinople in 1729, treats angels and demons with scholastic thoroughness and rejects the illicit arts with equal thoroughness. And yet the hmayil scrolls that carry the demon-binding material are, on the evidence of their own colophons, very often the work of priests, deacons and monastic scribes. The condemnation was not aimed at some pagan remnant outside the church. It ran through the middle of the church\'s own scriptorium, and both sides of the line were held by the same hands.',
            ],
            terms: [
                {
                    native: 'Սողոմոն',
                ...
                },
                {
                    native: 'մատանի',
                    translit: 'matani',
                    gloss: 'Ring. The object by which the authority is held and transferred; in Josephus\'s account of Eleazar it is the ring, not the word, that draws the demon out.',
                },
                {
                    native: 'դեւ',
                    translit: 'dew',
                ...
                },
                {
                    native: 'Ալ',
                    translit: 'Al',
                    gloss: 'The Al, the demon of childbirth in Armenian folk tradition, held to be hostile to the woman in labour and to the newborn. A large proportion of the surviving protective texts is directed against this figure.',
                },
                {
                    native: 'Գիրք հարցմանց',
                    translit: 'Girk\' hartsmants\'',
                    gloss: '\'The Book of Questions\', the great summa of Grigor Tatevatsi, completed at Tatev in 1397 and printed at Constantinople in 1729, which treats angels, demons and the illicit arts within a fully scholastic framework.',
                },
            ],
            texts: [
                {
                ...
                },
                {
                    ...
                    note: 'The earliest full statement that Solomon composed exorcistic formulae still in use, with the account of Eleazar and the ring performed before Vespasian. The bridge between the biblical Solomon and the Solomon of the magical literature.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'Completed at Tatev, 1397; printed at Constantinople, 1729. Scholastic treatment of angelic and demonic natures and a systematic rejection of divinatory and magical practice.',
                },
                {
                    title: 'James R. Russell, \'The Book of the Six Thousand: An Armenian Magical Text\'',
                    note: 'Bazmavep 147 (Venice, 1989), 221–243; reprinted in his Armenian and Iranian Studies (Harvard Armenian Texts and Studies 9, 2004). One of the few Armenian magical handbooks to have received a scholarly presentation; most of the corpus is still unedited.',
                },
                {
                    title: 'Frédéric Feydit, Amulettes de l\'Arménie chrétienne',
                    note: 'Venice: San Lazzaro, 1986, in the Gulbenkian armenological library. An edition of a hundred and fifty-four amulets from the San Lazzaro manuscripts, seventeenth to nineteenth century, with French translation — the readiest access to the demon-binding material as it actually circulated.',
                },
            ],
        },
        {
            ...
            terms: [
                ...
                },
                {
                    native: 'Քննիկոն',
                    translit: 'K\'nnikon',
                    gloss: 'The name given to Anania Shirakatsi\'s compendium of the sciences, formed on a Greek base. The Armenian orthography of this borrowed title is unstable in the manuscripts; the form given here is the one under which the work is customarily cited, and the work is more often referred to in transliteration than in script.',
                },
            ],
            texts: [
                {
                    title: 'The works of Anania Shirakatsi',
                    note: 'Cosmography, computistical treatises, tables and arithmetical problems, together with his autobiography — the only one left by a classical Armenian scholar; collected by A. G. Abrahamyan (Yerevan, 1944). The foundation of Armenian exact science.',
                },
                {
                    title: 'Ashkharhats\'oyts\' (the Armenian Geography)',
                    note: 'Generally attributed to Anania Shirakatsi, though the case for Movses Khorenatsi has also been argued; edited and translated by Robert H. Hewsen as The Geography of Ananias of Širak (Wiesbaden, 1992). A seventh-century world description built on Ptolemaic materials.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'Reckoned from 11 July 552; a wandering year of 365 days with no intercalation, drifting one day in four years and completing its circuit of the seasons in something over fourteen centuries. The technical literature on Armenian computus begins here.',
                },
                {
                    title: 'The calendar reform of Yovhannes Sarkavag (1084)',
                    note: 'The fixed calendar and the Lesser Armenian Era, instituted by the scholar of Haghpat at the opening of a new cycle, completing the reform Anania had been asked for four centuries earlier.',
                },
                {
                    title: 'Calendrical and astrological manuscripts of the Matenadaran',
                    note: 'Miscellanies carrying zodiacal tables, moon-books, lot-books and prognostics, largely unedited. The smallest manuscript in the collection, at about nineteen grams, is a fifteenth-century calendar.',
                },
            ],
        },
        {
            ...
            paragraphs: [
                ...
                'Amirdovlat Amasiatsi, who lived from about 1420 to 1496, is the tradition\'s great figure. Born at Amasya, he practised in Constantinople and served as physician at the court of Mehmed II; he read Greek, Arabic, Persian and Turkish, and his books absorb the pharmacological learning of all four. The Teaching of Medicine and the Akhrapatin, a formulary named after the Arabic aqrābādhīn tradition of compound-drug books, both belong to 1459; Useful for Medicine followed in the later 1460s; and at the end of his life, between 1478 and 1482, he compiled the vast alphabetical materia medica called Angitats\' anpet, \'Useless to the Ignorant\' — a title that is a warning rather than a boast, since the book refuses to be used by anyone who has not learned the art. It runs to some three and a half thousand entries, and its distinguishing feature is the synonymy: each substance is given with its names across the several languages of the eastern Mediterranean, which makes the book a lexicographical instrument as well as a pharmacological one. Its mineral entries are where the chemistry shows — the alums and the vitriols, sal ammoniac, the calcined metals, the stones with their attributed virtues — and they are inseparable from the Arabic tradition of ṣan\'a out of which they came. K. Basmajian\'s Vienna edition of 1926 and Stella Vardanyan\'s studies and translations are the modern gateway to this material.',
                'The workshop side of the tradition deserves equal notice, because it is where the Armenian handling of matter is most visible. Manuscripts carry recipes for the preparation of inks, of gold for writing, of glues and grounds and pigments; and the pigment that made Armenian illumination famous is vordan karmir, the crimson taken from an insect of the Ararat plain, prized across the Near East and used for both manuscripts and textiles. The vocabulary of these recipes is the vocabulary of the drug book — grind, dissolve, wash, burn, cool, purify — and it belongs to the same intellectual world in which a mineral can be corrected of its harmfulness by preparation and thereby made useful. There is a further edge to this, where pharmacy meets the amulet: the virtues of stones are recorded in the medical books, and stones and metals appear in the protective apparatus as things to be worn as well as things to be taken. A late medieval Armenian physician who set a mineral simple in a compound and a scribe who noted which stone was good against which trouble were working with the same assumption, which is that matter has properties beyond the obvious ones and that knowing them is a craft with a literature.',
            ],
            terms: [
                {
                    native: 'բժշկարան',
                ...
                },
                {
                    ...
                    gloss: '\'Useless to the Ignorant\', Amirdovlat Amasiatsi\'s alphabetical materia medica of 1478–82, with some three and a half thousand entries and their synonyms in several languages; edited by K. Basmajian, Vienna, 1926.',
                },
                {
                    native: 'Ախրապատին',
                    translit: 'Akhrapatin',
                    gloss: 'Amirdovlat\'s formulary of 1459, its title the Armenian form of the Arabic aqrābādhīn, the standard eastern designation for a book of compound drugs. Given in the form under which the work is customarily cited; the orthography of the borrowed title varies.',
                },
                {
                    native: 'Ուսումն բժշկութեան',
                    translit: 'Usumn bzhshkut\'ean',
                    gloss: '\'The Teaching of Medicine\', Amirdovlat\'s earlier general work, of the same year as the Akhrapatin; with Օգուտ բժշկութեան, Ogut bzhshkut\'ean, \'Useful for Medicine\', of the later 1460s, it frames his career on either side of the great materia medica.',
                },
                {
                ...
                },
                {
                    ...
                    gloss: '\'Worm\'s red\', the crimson dye obtained from an insect of the Ararat plain; the celebrated red of Armenian manuscripts and textiles, and the best-known product of Armenian applied chemistry.',
                },
            ],
            texts: [
                {
                ...
                },
                {
                    ...
                    note: 'Compiled 1478–82; edition by K. Basmajian (Vienna, 1926). Alphabetical materia medica of some three and a half thousand entries, each with its names across several languages.',
                },
                {
                ...
                {
                    title: 'Amirdovlat Amasiatsi, Usumn and Ogut bzhshkut\'ean',
                    note: '\'The Teaching of Medicine\' (1459) and \'Useful for Medicine\' (later 1460s). General practical medicine from the physician who served at the court of Mehmed II, framing his career on either side of the great materia medica.',
                },
                {
        ...
        },
        {
            ...
            paragraphs: [
                'The Armenian word for an angel, hreshtak, is also the word for a messenger and an ambassador, and the double sense is not a pun but the whole doctrine in miniature: an angel is defined by being sent. From that plain functional beginning the tradition built upward, and the instrument of the building was the Corpus Dionysiacum. The works attributed to Dionysius the Areopagite were rendered into Armenian in the early eighth century, the version being ascribed to Stepanos Siwnetsi working with Dawit\' Hiwpatos — an early translation by the standards of the whole Dionysian tradition, and correspondingly valuable as a textual witness, which is why Robert W. Thomson\'s edition of it appeared in the CSCO in 1987. With it came the Celestial Hierarchy and its nine orders arranged in three triads, and with the orders came a whole way of thinking about mediation: that light and knowledge descend by degrees, that each rank receives from the rank above and imparts to the rank below, and that the visible church images the invisible order. Armenian theology absorbed it thoroughly. Grigor Tatevatsi\'s Book of Questions catechises the nine orders as settled doctrine seven hundred years later.',
                'In worship and in painting the angels are everywhere. The Sharaknots\', the Armenian hymnal, carries canons for the feast of the holy archangels and of the heavenly hosts, and the liturgy is saturated with the assumption that the human assembly is the smaller half of a congregation. Gabriel dominates the iconography by way of the Annunciation: the Etchmiadzin Gospel, Matenadaran MS 2374, written in 989 at Bgheno-Noravank in Syunik by the scribe Hovhannes, is celebrated for the group of much earlier miniatures — sixth or seventh century — bound at its end, among them the Annunciation and the Adoration of the Magi, and it stands at the head of a long Armenian tradition of the annunciate angel in movement, one wing still lifted. Michael appears as captain and as the one who contends; in the amulet scrolls he is drawn armed. The archangels flank sanctuary hangings and doorways, which is a statement about thresholds: the point at which the holy begins is the point at which a guard is posted.',
                'Two angels belong particularly to the individual. The first is the guardian, the pahapan hreshtak, whose keeping is asked in the night offices of the Book of Hours and in the private prayers that accompany them — the angel appointed to one person, present at the bedside, grieved by sin, invoked by name of office rather than by proper name. The second is the angel of death, and here Armenian preserves something distinctive. In the folk tradition, outside the formal doctrine of the church, he is the Grogh, \'the Writer\', the one who records, who sets down what is allotted and who comes at the end to collect it; the name survives in living Armenian in the imprecation Գրողը տանի, \'may the Grogh take it\', which most speakers now use without thinking about what it says. The pairing of the recording angel and the taking angel in a single figure is worth sitting with. It makes death an act of accounting rather than of violence, and it makes the whole of a life a document.',
                'The amulet scrolls are where angelology becomes operative, and where the church\'s disquiet concentrates. The hmayils carry lists of angelic names, headed by the archangels of scripture and continued with names drawn from the apocryphal stock and from further afield, sometimes in ranks of seven, sometimes at much greater length. The reasoning behind the lists is the reasoning of the Solomonic literature: every hostile power has a power set over it, so to write the name of the counterweight is to place the counterweight. The church\'s objection was not to angels — few traditions honour them more elaborately — but to two things: to names that stand in no scripture and can be vouched for by no one, and to the treatment of a name as a device that operates by being written. Both objections are old, both are canonical, and both were made repeatedly by clergy who then, in their capacity as scribes, wrote the lists out. The Armenian material offers no resolution of that contradiction, only a very full record of it.',
            ],
            terms: [
                {
                    native: 'հրեշտակ',
                ...
                },
                {
                    native: 'Գրող',
                    translit: 'Grogh',
                    gloss: '\'The Writer\'. The angel of death in Armenian folk tradition rather than in the church\'s formal teaching, who both records what is allotted and comes to take it; surviving in the modern imprecation Գրողը տանի, \'may the Grogh take it\'.',
                },
                {
                    native: 'Շարակնոց',
                    translit: 'Sharaknots\'',
            ...
            texts: [
                {
                    ...
                    note: 'Rendered in the early eighth century, the version ascribed to Stepanos Siwnetsi with Dawit\' Hiwpatos; edited by R. W. Thomson, CSCO 488–489, Scriptores Armeniaci 17–18 (Leuven: Peeters, 1987). An early and textually significant witness to the Corpus Dionysiacum.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'Written 989 at Bgheno-Noravank in Syunik, scribe Hovhannes, patron Bishop Stepanos, with a group of sixth- or seventh-century miniatures bound at the end — among them the Annunciation and the Adoration of the Magi — and carved ivory covers of probable sixth-century Byzantine make. Codex and covers were not originally one object.',
                },
                {
                    title: 'Grigor Tatevatsi, Girk\' hartsmants\'',
                ...
                {
                    title: 'Frédéric Feydit, Amulettes de l\'Arménie chrétienne',
                    note: 'Venice, 1986. An edition of a hundred and fifty-four amulets with French translation, and the readiest published access to the angelic name-lists as they actually stand in the scrolls, with their apocryphal and unvouched-for members.',
                },
            ],
        },
        {
            ...
            terms: [
                ...
                },
                {
                    ...
                    gloss: 'The prayer ascribed to Cyprian of Antioch, the converted magician of the legend; the most widely diffused Armenian protective prayer, standard in the amulet scrolls and printed in the Urbat\'agirk\'. The saint\'s name is given in its usual Armenian form.',
                },
                {
                ...
                },
                {
                    ...
                    gloss: 'The \'Friday Book\', Venice 1512, the first printed Armenian book — sixty-two leaves in red and black, a handbook of prayers and remedies for the sick including long extracts from the Narek and the prayer of Cyprian.',
                },
                {
                    native: 'Նարեկավանք',
                    translit: 'Narekavank\'',
            ...
            texts: [
                ...
                },
                {
                    ...
                    note: 'Venice, 1512, printed by Yakob Meghapart. The first book printed in Armenian: sixty-two leaves in red and black with twenty-four illustrations, collecting prayers and remedies for the sick, the prayer of Cyprian, and long extracts from the Narek.',
                },
                {
                    title: 'The Prayer of Cyprian',
                    note: 'Attributed to Cyprian of Antioch, the magician of the legend who became bishop and martyr. The standard Armenian protective prayer, transmitted in prayer books, in print, and at length in the amulet scrolls.',
                },
                {
                    title: 'Zhamagirk\' (the Book of Hours)',
        ...
        },
        {
            ...
            terms: [
                ...
                },
                {
                    native: 'բոլորգիր',
                    translit: 'bolorgir',
                    gloss: '\'Round writing\', the compact minuscule that succeeded the monumental erkat\'agir. Most scrolls are in fact written in its cursive descendant, notrgir, the small notarial hand of the later manuscript centuries.',
                },
                {
                ...
                },
                {
                    native: 'Կիպրիանոս',
                    translit: 'Kiprianos',
                    gloss: 'Cyprian of Antioch, the magician of the legend who became bishop and martyr, and the patron of the great Armenian protective prayer. Given in its usual Armenian form.',
                },
                {
                    native: 'չար աչք',
                    translit: 'ch\'ar ach\'k\'',
                    gloss: '\'Evil eye\' — the commonest of the harms the scrolls are made against, and the one whose remedies survive most vigorously into modern practice.',
                },
                {
                    native: 'Մատենադարան',
                    translit: 'Matenadaran',
                    gloss: 'The Mesrop Mashtots Institute of Ancient Manuscripts, Yerevan, which holds the largest collection of hmayils; its published totals range from some seventeen thousand manuscripts to about twenty-three thousand items, depending on whether fragments and scrolls are counted.',
                },
            ],
            texts: [
                {
                    title: 'Frédéric Feydit, Amulettes de l\'Arménie chrétienne',
                    note: 'Venice: San Lazzaro, 1986, in the Gulbenkian armenological library. An edition, with French translation, of a hundred and fifty-four amulets from the San Lazzaro manuscripts of the seventeenth to nineteenth centuries; the standard point of entry to the genre.',
                },
                {
                    title: 'The hmayil collection of the Matenadaran',
                    note: 'Hundreds of manuscript scrolls in Yerevan, the majority unedited; further collections at the Armenian Patriarchate of Jerusalem, at Venice and Vienna, and scattered across Paris and other European and American libraries.',
                },
                {
                    title: 'The Prayer of Cyprian',
                    note: 'The long apotropaic prayer ascribed to Cyprian of Antioch — the single most frequently copied text in the scrolls, and among the contents of the first Armenian printed book.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'From the eighteenth century onward the scrolls were printed as well as copied, which standardised their contents and multiplied them; manuscript production continued in parallel.',
                },
            ],
        },
        {
            ...
            paragraphs: [
                ...
                'The technical apocalyptic corpus proper is smaller and its chronology contested. Its best-known member is the Seventh Vision of Daniel, which belongs to the widespread family of Daniel apocalypses that also has Greek, Syriac and Coptic members, though this particular text survives only in Armenian, having been composed in Greek and lost there. Grigor Kalemkiar edited it with a German translation in 1892; Sergio La Porta\'s English translation appeared in 2013, and La Porta argues for composition in the late fifth century, against the Roman Empire, its collapse and its Antichrist. Other readings have pushed it later, and the debate is not closed. Alongside it Armenian transmits versions of the Apocalypse of Pseudo-Methodius, a seventh-century Syriac work responding to the Arab conquests, with its Last Emperor who surrenders his crown at Golgotha and its \'sons of Ishmael\' — the texts\' own term for the conquerors, and one worth marking as theirs and not ours. Alongside these stand the Vision of Enoch the Just, a historical apocalypse whose date remains disputed, placed by Anders Hultgård among the political apocalypses circulating between roughly the seventh and tenth centuries; and a prophecy circulating under the name of Nerses the Great, in fact a composite of several layers embedded in his Life, its predictions written after the event and its earliest known manuscript of 1131, which foretold the sufferings of Armenia and its eventual deliverance and was quoted with real political force in the nineteenth century. The Antichrist in this literature is the Nerr, and the recurring observation of the scholarship is that his features are drawn from whatever power the writer is living under.',
                'There is one further genre that belongs here although it is not apocalyptic by form, and that is the colophon. Armenian scribes wrote long memorials at the ends of their manuscripts — the yishatakaran — recording who paid for the book, who copied it, and what was happening while it was being copied; and because of when and where they were written, an extraordinary number of them record invasion, siege, famine, plague and massacre. Avedis Sanjian\'s Colophons of Armenian Manuscripts, 1301–1480 assembled them for the worst of the medieval centuries, and reading them in sequence is a particular experience: the scribes reach again and again for the language of the last days, because it is the only register adequate to what they are describing, and then finish the book anyway. That combination — apocalyptic vocabulary in the service of continued work — is probably the truest description of the genre in Armenian. It should be read as the record of a people\'s endurance under other people\'s rule, and read carefully, because a literature that names the enemy of God has always been available for reuse against neighbours, and has been so used.',
            ],
            terms: [
                {
                    native: 'տեսիլ',
                ...
                {
                    native: 'Տեսիլ Ենովքայ',
                    translit: 'Tesil Enovk\'ay',
                    gloss: '\'The Vision of Enoch [the Just]\', an Armenian historical apocalypse of disputed date, its kingdoms and rulers given under symbolic names. Cited here in its customary Armenian form; the work is usually referred to in translation.',
                },
                {
                    native: 'Դանիէլ',
                    translit: 'Daniel',
                    gloss: 'Daniel. The patron of the whole eastern apocalyptic tradition; the Armenian Seventh Vision belongs to a family with Greek, Syriac and Coptic members, though the Armenian text itself survives in no other language.',
                },
                {
                    native: 'Նեռ',
                    translit: 'Nerr',
                    gloss: 'The Antichrist. A short, blunt Armenian word rather than a Greek loan, which tells you how thoroughly the figure was naturalised.',
                },
                {
                    native: 'յիշատակարան',
            ...
            texts: [
                ...
                },
                {
                    ...
                    note: 'Surviving only in Armenian, composed in Greek. Edited with German translation by G. Kalemkiar, \'Die siebente Vision Daniels\', WZKM 6 (1892); English translation by Sergio La Porta in Old Testament Pseudepigrapha: More Noncanonical Scriptures, vol. 1 (Eerdmans, 2013), who argues for a late fifth-century date.',
                },
                {
                    title: 'The Armenian Apocalypse of Pseudo-Methodius',
                    note: 'The Armenian branch of the most influential of all medieval apocalypses — Syriac in origin, seventh century, a response to the Arab conquests — with its succession of empires and its Last Emperor who lays down the crown at Golgotha.',
                },
                {
                    title: 'The Vision of Enoch the Just',
                    note: 'An Armenian historical apocalypse of disputed date, its rulers veiled under a symbolic scheme; placed by Anders Hultgård among the political apocalypses of roughly the seventh to tenth centuries. Studied, with the whole corpus, in K. B. Bardakjian and S. La Porta, eds., The Armenian Apocalyptic Tradition: A Comparative Perspective (Brill, SVTP 25, 2014).',
                },
                {
