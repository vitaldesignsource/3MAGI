...
export default {
    note: 'Independent verification pass over the draft. Every native-script string was extracted and run character by character through python3 unicodedata.name(): sixty-eight distinct strings, and with a single exception every codepoint resolved inside the Ethiopic block (U+1200-U+139F) with a proper name and no lookalikes from Cyrillic, Latin, Armenian or the Ethiopic Supplement ranges. The exception was a U+200B ZERO WIDTH SPACE sitting immediately before the word for cross in the second paragraph of the exorcism essay; it has been removed. The draft\'s own note had asserted that the batch contained no stray codepoints, which was false, and had described corrections to Ethiopic strings that occur nowhere in the essays at all; that note has been discarded and replaced with this one. Three transliterations were out of step with the script standing beside them and have been brought into line: the thirteenth month was rendered with a labiovelar although the second character is U+1309 ETHIOPIC SYLLABLE GU and carries none, so it now reads Pagumen; Nineveh was rendered with a sixth-order first syllable although the character is U+1290 ETHIOPIC SYLLABLE NA, first order, so it now reads Nanawe; and the word for incense lost its pharyngeal in transliteration and has had it restored. Where a spelling could not be confirmed the transliteration stands in the native field and the gloss says so plainly: Semyaza and Azaz\'el, whose Ge\'ez forms in the Enoch manuscripts I could not verify; Warzalya, whose orthography varies between manuscripts; the Ge\'ez title of the Ascension of Isaiah; the Ge\'ez heading of the Astronomical Book; and the Arabic-derived planet names of the astrological material. On sources: Strelcyn\'s 1955 volume was checked and carries maftehe seray as its own subtitle, which confirms the genre name used to head the exorcism essay. The Qumran Enoch count was internally inconsistent, since eleven manuscripts cannot be catalogued 4Q201-4Q212, and now reads eleven or twelve. The Hermeneia attribution has been corrected: the first volume of 2001 is Nickelsburg\'s alone. Two descriptions were simply wrong and have been rewritten: the Awda Nagast, which is built on sixteen circular tables named for Ethiopian lakes and rivers rather than on prognostication from the weekday a year opens; and the Nagara Maryam, which is a life of the Virgin divided into readings across the twelve months and chiefly concerned with the flight into Egypt, not a Nativity lection. On overstatement: Milik\'s reconstruction of an Enochic pentateuch with the Book of Giants standing where the Parables later stood is now given as his proposal rather than as fact, and the Boccaccini volume is said to have registered a majority rather than to have settled anything. The claim that the church has always condemned zar has gone, as has the description of zar as an anomaly; the movement of people between holy water and zar is now attributed to the ethnographic literature rather than asserted, and Janice Boddy\'s critique of Lewis has been added. The claim that the Miracles of Mary are read more than anything else in Ethiopian religion has been qualified, the Psalter having at least as strong a claim. Mercier\'s fieldwork is no longer said to underwrite all serious understanding of the scrolls, and the killing of an animal for a scroll\'s parchment is given as documented in the cases he recorded rather than as universal. The blanket statement that the Ethiopian materia medica is effective has been replaced by the two cases that are actually documented. On practice: nothing here is operative. No divine name, formula, prayer text, divinatory table, plant identification or quantity is reproduced, and the passage on the divinatory tables says in terms that their working is not set out. Buda is described throughout as an accusation levelled at people and never as a property anyone has, the damage it has done to the Beta Israel above all is stated, and the essay now notes that the artisan groups accused include women potters as well as smiths, so that its closing image does not stand for the whole. Zar, sabal and the Marian Kidan are living practice and are written in the present tense. Uriel\'s monthly commemoration is still not asserted, since I could confirm Michael\'s twelfth, Gabriel\'s nineteenth and Raphael\'s third but no settled day for Uriel; and the Enochic year of three hundred and sixty-four days is kept distinct from the Ethiopian civil calendar, which intercalates and descends from Egypt.',
    themes: [
        {
            ...
            paragraphs: [
                ...
                'One honest caution belongs at the end. The Parables, the section containing the Son of Man, are the one book of the five with no Aramaic representative at Qumran. Milik took the silence as decisive, proposed a Christian composition of the third century after Christ, and reconstructed an Enochic pentateuch in which the Book of Giants, which is attested at Qumran, occupied the place the Parables afterwards took; neither the late date nor the reconstruction has found many followers. The internal indications — an allusion to Parthians and Medes overrunning the land, a passage about the hot springs frequented by the kings and the mighty — point rather to the last decades before Christ or the first after, and the papers gathered in Gabriele Boccaccini\'s Enoch Seminar volume of 2007 registered a majority near that range without producing a consensus. The date matters because it decides whether the Parables are evidence for the world in which the Gospels use the phrase Son of Man, or evidence of that phrase being read back. The Geʿez manuscripts cannot answer the question; they only preserve it.',
            ],
            terms: [
                {
                    native: 'መጽሐፈ ሄኖክ',
                ...
                },
                {
                    native: 'ብርሃናት',
                    translit: 'bərhanat',
                    gloss: 'Luminaries, plural of bərhan, light. The subject of chapters 72–82, which the manuscripts head with a phrase about the courses of the luminaries of heaven; the Geʿez wording of that heading varies between manuscripts and is not given here in script.',
                },
                {
                    native: 'Semyaza',
                    translit: 'Semyaza (Aramaic Šemiḥazah)',
                    gloss: 'Given in transliteration only: I could not confirm the Geʿez orthography of the name in the Enoch manuscripts. The leader of the two hundred Watchers who descend on Hermon and bind themselves by oath.',
                },
                {
                    native: 'ʿAzazʾel',
            ...
            texts: [
                {
                    ...
                    note: 'Complete only in Geʿez, in manuscripts of the fifteenth century and later; two recensions are distinguished, an older and a later vulgate. Standard modern edition: Michael A. Knibb, The Ethiopic Book of Enoch (2 vols, Oxford, 1978), printed from Rylands Ethiopic MS 23 with full apparatus. Commentary in the Hermeneia series: George W. E. Nickelsburg (2001) on chapters 1–36 and 81–108, Nickelsburg and James C. VanderKam (2012) on 37–82.',
                },
                {
                    title: 'The Aramaic fragments, Qumran Cave 4',
                    note: 'The remains of some eleven or twelve manuscripts of Enochic material, catalogued 4Q201–4Q212, the earliest placed palaeographically in the first half of the second century before Christ or earlier; edited by J. T. Milik, The Books of Enoch: Aramaic Fragments of Qumrân Cave 4 (Oxford, 1976). No fragment of the Parables is among them.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'A fourth-century Greek codex carrying much of the Epistle of Enoch (chapters 97–107) alongside Melito of Sardis on the Passover; published by Campbell Bonner in 1937.',
                },
                {
                    title: 'Richard Laurence, The Book of Enoch the Prophet (Oxford, 1821)',
                    note: 'The first translation into a European language, made from one of the manuscripts James Bruce deposited at the Bodleian after his return from Ethiopia in 1773. Laurence followed it with the Geʿez text in 1838.',
                },
                {
                    title: 'August Dillmann, Liber Henoch aethiopice (Leipzig, 1851)',
                    note: 'The critical edition that made Enoch a subject of scholarship rather than a curiosity, with Dillmann\'s German translation and commentary following in 1853.',
                },
            ],
        },
        {
            ...
            terms: [
                ...
                },
                {
                    native: 'መቃብያን',
                    translit: 'Mäqabyan',
                    gloss: 'The three Ethiopic books of that name, canonical in the Ethiopian Old Testament and unrelated in content to the Greek books of Maccabees despite the resemblance of the title; generally taken to be mediaeval compositions.',
                },
                {
                    native: 'ታቦት',
                    translit: 'tabot',
                ...
                },
                {
                    ...
                    gloss: 'The Ascension of Isaiah, given here in transliteration because I could not confirm the Geʿez spelling of the title as it stands in the manuscripts. The work survives complete in Geʿez alone.',
                },
            ],
            texts: [
                {
                    title: 'The Book of Jubilees (Mäṣḥafä Kufale)',
                    note: 'Complete only in Geʿez; some fourteen or fifteen fragmentary Hebrew manuscripts from Qumran, about a quarter of the text in a Latin palimpsest at the Ambrosiana. Critical edition and translation by James C. VanderKam, CSCO 510–511 (1989). Composed in Hebrew in the middle of the second century before Christ.',
                },
                {
                    title: 'The Ascension of Isaiah',
                    note: 'Complete only in Geʿez; partial Greek, Latin, Coptic and Old Church Slavonic witnesses. A composite of a Jewish martyrdom narrative and a Christian visionary ascent through seven heavens. Critical edition in Corpus Christianorum Series Apocryphorum 7–8 (1995), with the commentary of Enrico Norelli.',
                },
                {
                    title: 'Kəbrä Nägäśt',
                ...
                },
                {
                    ...
                    note: 'Canonical in the Ethiopian Old Testament, without textual relation to 1–4 Maccabees, and generally dated to the mediaeval period. Described in August Dillmann\'s catalogues of the Ethiopic manuscripts of the British Museum (1847) and the Bodleian (1848); critical editing and translation are recent, uneven and still in progress.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'Ostkirchliche Studien 23 (1974): the article that set out clearly what the traditional figure of eighty-one books does and does not mean, and why the surviving lists differ from one another.',
                },
            ],
        },
        {
            ...
            summary: 'Four names carried by half a country, a commemoration in every month, and the two intercessors on whom Ethiopian devotion actually rests.',
            paragraphs: [
                'Ethiopian Christianity is populated. The angels are not an abstraction to be affirmed in a creed but named persons with feasts, homilies, hymns, dedications and namesakes. The tradition knows seven, following the twentieth chapter of Enoch, which names seven holy angels who watch — Uriel, Raphael, Raguel, Michael, Saraqael, Gabriel and Remiel — and Ethiopian iconography gives all seven their place. But four carry the weight of devotion: ሚካኤል, ገብርኤል, ሩፋኤል and ኡራኤል. They are in the churches, painted on the walls in ranks with drawn swords, and they are in the population: Gäbrä Mikaʾel, servant of Michael, and Haylä Mikaʾel, strength of Michael, and Wäldä Gäbrəʾel, son of Gabriel, are ordinary Ethiopian names, given at baptism and carried for life. To name a child for an archangel is to place him under a patron in a quite specific sense — the patron whose day the household will keep, whose feast it will observe with bread and drink for the neighbours, and to whom it will turn when something goes wrong. This is the ground on which everything else in this hall stands, and it should be understood before the amulets and the exorcisms are approached, because the amulets and the exorcisms invoke exactly these names and nothing stranger.',
                'The commemorations are monthly, not annual, which changes their weight entirely. Michael is kept on the twelfth day of every month, Gabriel on the nineteenth, Raphael on the third; a feast that returns twelve or thirteen times a year is not an anniversary but a rhythm. Certain of these recurrences carry more: Ḫədar Mikaʾel, Michael\'s day in the third month, and Taḫśaś Gäbrəʾel on the nineteenth of the fourth, which draws to the shrine at Kulubi in the eastern highlands one of the largest pilgrimages in the country — many walking for days, and children born after a vow to the archangel brought there to be baptised. The church on that hill was founded by Ras Mäkonnen after the victory at Adwa and rebuilt under Haile Selassie in 1962; Gabriel has a second Kulubi feast in Ḥamle. The Ethiopian ስንክሳር, the synaxary translated from Arabic and then enlarged with Ethiopian saints, supplies the readings for these days, and beside it stands a body of homiletic literature written for them: the ድርሳነ ሚካኤል, a collection of discourses on Michael arranged for the monthly rounds, and the mälkəʾ hymns, a distinctively Ethiopian genre in which stanza after stanza salutes a different part of the honoured one\'s body, working downward from the hair of the head. Above the archangels the liturgy sets the ካህናተ ሰማይ, the twenty-four priests of heaven taken from the fourth chapter of the Apocalypse, who appear in the anaphoras, in the painted ceilings, and in the great intercessory prayers.',
            ...
            terms: [
                ...
                },
                {
                    native: 'ሚካኤል',
                    translit: 'Mikaʾel',
                    gloss: 'Michael. Commemorated on the twelfth of every Ethiopian month, and among the commonest elements in Ethiopian personal names and church dedications.',
                },
                {
                    native: 'ገብርኤል',
                    translit: 'Gäbrəʾel',
                    gloss: 'Gabriel. Commemorated on the nineteenth of every month; the shrine at Kulubi in eastern Ethiopia draws a mass pilgrimage on his feast of Taḫśaś nineteen.',
                },
                {
                    native: 'ሩፋኤል',
                    translit: 'Rufaʾel',
                    gloss: 'Raphael. Commemorated on the third of every month, with a great feast in Ṗagumen, the short thirteenth month; the synaxary account of his church on an island near Alexandria is the reading for the day.',
                },
                {
                    native: 'ኡራኤል',
                    translit: 'Uraʾel',
                    gloss: 'Uriel. In Enoch the guide who shows the patriarch the courses of the luminaries and declares himself set over them — the archangel of measure, and so of the calendar. No monthly day is claimed for him here, since I could not confirm one as I could Michael\'s, Gabriel\'s and Raphael\'s.',
                },
                {
                    native: 'ስንክሳር',
                    translit: 'Sənkəssar',
            ...
            texts: [
                ...
                {
                    title: '1 Enoch 20, and 72–82',
                    note: 'Chapter 20 names the seven holy angels who watch, Uriel first among them; chapters 72–82 are Uriel\'s dictation to Enoch of the gates of the sun, the phases of the moon and the reckoning of the year — the textual basis of his Ethiopian character as the angel who measures.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'Not a text but the reason so many of these texts can be studied: the great microfilming campaign of Ethiopian manuscripts, catalogued over decades by Getatchew Haile and others and held at the Hill Museum and Manuscript Library, Collegeville, Minnesota.',
                },
                {
                    title: 'Encyclopaedia Aethiopica, ed. Siegbert Uhlig (vol. 5 ed. Alessandro Bausi)',
                    note: 'Five volumes, 2003–2014: the standard reference for every name, feast, text and practice in this hall, and the first place to check any claim made about them.',
                },
            ],
        },
        {
            ...
            summary: 'Spirits out of the giants, a demoness ridden down by a saint, an accusation that has done lasting harm, and a possession cult the church condemns and people go on attending.',
            paragraphs: [
            ...
            terms: [
                ...
                },
                {
                    native: 'ዛር',
                    translit: 'zar',
                    gloss: 'A possessing spirit, and the practice built around relations with such spirits. Placated and accommodated rather than expelled; found across the region\'s religious divisions, and condemned by the Ethiopian Orthodox Church as outside its own discipline.',
                },
                {
                    native: 'ውቃቢ',
                    translit: 'wəqabi',
            ...
            texts: [
                ...
                {
                    title: 'I. M. Lewis, Ecstatic Religion (1971), with Janice Boddy, Wombs and Alien Spirits (1989)',
                    note: 'Lewis set zar beside the bori of the Hausa and the possession cults of Sudan and Egypt and argued for possession as an idiom of the socially peripheral; Boddy\'s Sudanese fieldwork is the standard correction, reading possession as cultural interpretation rather than compensation. See also Women\'s Medicine: The Zar-Bori Cult in Africa and Beyond, ed. Lewis, al-Safi and Hurreiz (1991).',
                },
                {
        ...
        },
        {
            ...
            summary: 'A strip of parchment cut to the height of the body it defends, painted with eyes that stare back, and written with names that were never meant to be read as ordinary language.',
            paragraphs: [
                'The ክታብ is the most immediately recognisable object in Ethiopian religious material culture and among the least understood outside it. It is a strip of parchment, usually two or three sheets sewn end to end, written in Geʿez in the small hand used for such things, painted at intervals with figures, and rolled into a leather case to be worn about the neck or the waist, or kept unrolled at the head of a bed or hung on the wall of a house. The governing fact of its construction is its length. The scroll is made to the height of the person for whom it is made: it is measured against the body, and the correspondence is not decorative but functional. Jacques Mercier, whose fieldwork with practising scroll-makers underlies most of what is securely known about these objects, put the logic plainly — the scroll is a substitute body, standing between its owner and what comes at them, and its dimensions are its owner\'s dimensions because that is what it is for.',
                'In the commissions Mercier documented in the twentieth century, the parchment was taken from an animal killed for the purpose, and the killing belonged to the operation rather than preceding it: the logic is one of transfer, the affliction moved into the animal, so that the material carrying the remedy is the material that carried the illness away. Sheep and goat both served, according to means. This was not the only way a scroll was made — a great many were written on ordinary parchment bought or already to hand — and it should not be generalised into a rule. Once prepared, the parchment was written by a ደብተራ, and the commission was personal: the client\'s name and often the mother\'s name were written into the text at the points where the formulae required a name, so that a finished scroll is not a generic object but something closer to an instrument made out to a particular party. Unfinished scrolls with blank spaces awaiting a name survive in collections, and are among the more revealing items in them.',
                'What is written on it is prayer and አስማት. The prayers are recognisably the church\'s — invocations of the Trinity, of Mary, of the archangels, of the cross — and the ʾasmat are names: names of God, names of angels, and long sequences of names that mean nothing in Geʿez or in any other known language, transmitted as sound and copied as shapes. None are reproduced here. The Ethiopian tradition inherits the word itself from Arabic, and the practice belongs to the whole late-antique and mediaeval Near East, where the efficacy of a name lies precisely in its being the true one and therefore not the ordinary one. Beside the names stand the ሥዕል, the painted images, and Mercier\'s central argument concerns them: they are not illustrations of the text but instruments in their own right. The recurring motif is a face, frontal and symmetrical, dominated by enormous open eyes, and it is placed where it will be looked at. Against ቡዳ, an affliction transmitted by looking, the scroll answers with a gaze that does not blink. Other figures recur — an angel with a drawn sword, Susənyos riding down the demoness, and above all the interlaced net, a lattice of knotted bands understood as a trap in which a spirit is caught and held, and associated in some of the texts with Solomon.',
                'The scrolls left Ethiopia in very large numbers, and where they now are is not a neutral question. The Wellcome Collection in London holds one of the great assemblages, gathered through the medical-historical collecting of the early twentieth century; the material the Dakar–Djibouti mission brought back in 1933 is divided between the Bibliothèque nationale de France and the Musée du quai Branly, which inherited the ethnographic collections of the Musée de l\'Homme; the British Library holds others, as does Princeton, whose Garrett collection of Ethiopic manuscripts was catalogued by Enno Littmann in 1904. The British Library\'s Ethiopic holdings include several hundred manuscripts taken from Mäqdäla in 1868 after the British expedition against the emperor Tewodros II, and restitution claims over that material are live and unresolved. Meanwhile the largest and most important collection is in Ethiopia itself, at the Institute of Ethiopian Studies in Addis Ababa, and the practice these objects come from has not stopped. Scrolls are still made. It is worth saying that a scroll in a vitrine is a scroll that has been separated from the person it was cut to fit, and that this is a loss of information as well as of property.',
            ],
            terms: [
                {
                    native: 'ክታብ',
                ...
                },
                {
                    native: 'አስማት',
                    translit: 'ʾasmat',
                    gloss: 'Names — from Arabic asmāʾ. The powerful and secret names written on scrolls: names of God, of angels, and long sequences transmitted as sound alone, whose sense is not recoverable and was not expected to be. None are given in this hall.',
                },
                {
                    native: 'ደብተራ',
                    translit: 'däbtära',
                ...
                },
                {
                    native: 'ሥዕል',
                    translit: 'śəʿəl',
                    gloss: 'Image, picture. On a scroll the painted figures — the frontal face with its great eyes, the angel with the sword, the interlaced net — which the tradition treats as operative rather than illustrative.',
                },
                {
                    native: 'ብራና',
                    translit: 'bəranna',
                    gloss: 'Parchment. The support of every Ethiopian manuscript and every scroll, prepared from sheep or goat.',
                },
                {
                    native: 'ልፋፈ ጽድቅ',
            ...
            texts: [
                {
                    title: 'Jacques Mercier, Ethiopian Magic Scrolls (New York, 1979)',
                ...
                },
                {
                    ...
                    note: 'Translation and study of the Ləfafä Ṣədq, the scroll of names buried with the dead. Budge\'s framing is of its period, but the text and plates remain useful.',
                },
                {
                    title: 'Marcel Griaule, Le livre de recettes d\'un dabtara abyssin (Paris, 1930)',
                    note: 'A däbtära\'s own working notebook, published in facsimile with translation: the single most direct witness to what such a practitioner actually kept written down.',
                },
                {
                    title: 'The Wellcome Collection Ethiopian scrolls, London',
                    note: 'One of the largest assemblages outside Ethiopia, acquired through Henry Wellcome\'s medical-historical collecting; catalogued by Stefan Strelcyn in 1972 and increasingly digitised.',
                },
                {
        ...
        },
        {
            ...
            paragraphs: [
                'The Ethiopian magico-medical books are working documents and look like it. They are small, often unbound or crudely bound, written in a rapid hand in Geʿez with Amharic intruding wherever precision about a plant or a symptom is needed, and they are organised by complaint. An entry gives the ailment, names what is to be gathered or ground or infused, and gives the prayer or the name that accompanies it — and the three elements are not separable into a medical part and a magical part. That distinction is ours. In the logic of the books the plant works, and the name works, and they work together, in the same way that a dose and a time of day work together. What such a book is called varies: scribes head them differently, and Western scholarship has used the general term ጥበብ, craft-wisdom, and the phrase መጽሐፈ ጥበብ, for a genre with no single fixed title. Stefan Strelcyn\'s Médecine et plantes d\'Éthiopie catalogued and analysed these texts more thoroughly than anyone before or since, and Marcel Griaule\'s publication in 1930 of one däbtära\'s actual notebook remains the most intimate document we have of the practice. The identifications, preparations and quantities the books give are not reproduced in this hall; what is described here is the shape of the literature, not its contents in use.',
                'Parts of the materia medica have a documented pharmacological history. The flowers of ኮሶ, Hagenia abyssinica, were the standard Ethiopian remedy against tapeworm — a condition endemic where raw beef is eaten — and were exported and examined by European pharmacologists in the nineteenth century, who found them anthelmintically active. Endod, Phytolacca dodecandra, long used domestically as a soap-plant, was investigated from the 1960s by the Ethiopian scientist Aklilu Lemma for its molluscicidal action against the snails that carry schistosomiasis, and became the subject of an international research programme. Those are two documented cases and should not be generalised into a verdict on the pharmacopoeia as a whole, which contains a great deal that has never been tested and some that would not survive testing. Rue, garden cress and a range of aromatic herbs appear constantly. So do minerals, animal substances, smoke and water: fumigation with ዕጣን, incense, and washing with ጸበል, holy water, sit in the same lists as decoctions, and the recipe will often specify how many times something is to be said over the preparation. Richard Pankhurst\'s medical history of Ethiopia sets this pharmacopoeia against the epidemiological realities it was addressed to, and the fit is closer than a dismissive reading would expect.',
                'Two operations in these books deserve particular attention because they show the underlying theory. The first is the naming of the illness. The prayer does not ask vaguely for healing; it identifies the complaint by name and addresses it, in the second person, as something that has come and can be told to go. The disease is treated as an agent with a name, and the practitioner\'s advantage over it is that he knows the name and it does not know his — the same logic that governs the ʾasmat of the scrolls, transposed from demons to fevers. The second is what the sources describe as the drinking of the writing: text written in ink is washed from its surface, and the washing is swallowed, so that what was written enters the body. This is not a peculiarity of Ethiopian Christianity. It is one of the most widely reported practices of the whole region, described with Qurʾanic text on wooden writing boards across Muslim Africa from Senegal to the Horn, and with Christian text in Ethiopia and Egypt. Behind it lies a proposition about scripture that both traditions hold and that neither states as a doctrine: that the words are not only meaningful but substantial, and that the ink is a carrier.',
                'The man who did all this was the ደብተራ, and his position is the most interesting sociological fact in this hall. He is a product of the church\'s own educational system, which is long and demanding — years in the school of reading, then the school of chant, then, for the ambitious, the school of qəne, the improvised religious poetry with its double meanings of gold and wax, and the school of interpretation. He serves the liturgy, sings the antiphons, carries the prayer-staff and the sistrum, and is not ordained. His living is not assured, and what he sells is his literacy: he writes scrolls, compounds remedies, casts the letters of a name into a calculation, and is consulted by people who would not admit to consulting him. The church has periodically moved against the practice — the emperor Zärʾa Yaʿəqob\'s legislation in the fifteenth century, embodied in his መጽሐፈ ብርሃን, is the great instance, condemning sacrifice to spirits and requiring Christians to carry the names of the Trinity on their persons instead — and the practice has periodically continued. It should also be said that the same root gives ṭäbib, which is at once the sage and the artisan, and that the artisan groups — smiths, weavers, tanners, and the potters, largely women — are the groups most often accused of ቡዳ. Skill and suspicion have run together in this vocabulary for a very long time.',
            ],
            terms: [
                {
                    native: 'መጽሐፈ ጥበብ',
                ...
                },
                {
                    native: 'ጠቢብ',
                    translit: 'ṭäbib',
                    gloss: 'Wise man; skilled craftsman; smith. That the word for the artisan is the word for the sage, and that artisan families are the group most often accused of the evil eye, is the knot at the centre of this subject.',
                },
                {
                    native: 'ሥራይ',
                    translit: 'śəray',
                ...
                },
                {
                    native: 'ኮሶ',
                    translit: 'kosso',
                    gloss: 'Hagenia abyssinica, whose flowers were the standard Ethiopian anthelmintic against tapeworm; examined by nineteenth-century European pharmacology and found active. Conventionally spelt kosso in English.',
                },
                {
                    native: 'ዕጣን',
                    translit: 'ʿəṭan',
            ...
            texts: [
                ...
                },
                {
                    ...
                    note: 'The Book of Light, mid-fifteenth century: doctrinal and disciplinary legislation which among much else condemns sacrifice to spirits and prescribes that Christians carry the divine names. The clearest statement of the official position against which the däbtära\'s practice ran.',
                },
                {
                    title: 'Ethiopian magico-medical manuscripts, Wellcome Collection and Bibliothèque nationale de France',
                    note: 'The principal European holdings of the recipe literature, catalogued in part by Strelcyn, whose manuscript catalogues for the Wellcome (1972), the British Library (1978) and the Accademia dei Lincei remain the working tools of the field.',
                },
            ],
        },
        {
            ...
            texts: [
                {
                    ...
                    note: 'The great Ethiopian Marian collection, frequently illuminated; manuscripts range from a few dozen miracles to several hundred. Its European sources were traced by Enrico Cerulli in Il libro etiopico dei Miracoli di Maria e le sue fonti nelle letterature del Medio Evo latino (Rome, 1943).',
                },
                {
                    title: 'Arganonä Wəddase, by Abba Giyorgis of Sägla',
                    note: 'A Marian poem in seven daily parts by the greatest Geʿez author of the early fifteenth century (d. 1425), who also wrote the Mäṣḥafä Məśṭir against heresies, an Anaphora of Our Lady, and a recension of the Book of Hours.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'Fifteenth-century decrees making the reading of the Miracles obligatory, penalising denial of their authority, and instituting thirty-three annual Marian feasts; set out in the emperor\'s own writings and discussed in Taddesse Tamrat, Church and State in Ethiopia 1270–1527 (Oxford, 1972).',
                },
                {
                    title: 'Nägärä Maryam (The Story of Mary)',
                    note: 'A separate Geʿez life of the Virgin, drawing on infancy traditions and largely concerned with the family\'s wanderings in Egypt, in which Mary blesses those who receive her well and punishes those who do not. It is divided into readings for the twelve months of the Ethiopian year and survives in many manuscripts under varying titles.',
                },
            ],
        },
        {
            ...
            terms: [
                ...
                },
                {
                    native: 'እግዚአብሔር',
                    translit: 'Ǝgziʾabḥer',
                    gloss: 'God. Traditionally explained as ʾəgziʾa, lord of, with bəḥer, land or nation. The name that heads these texts, and in their own understanding not a label for the power but the means of applying it.',
                },
                {
            ...
            texts: [
                {
                    title: 'Stefan Strelcyn, Prières magiques éthiopiennes pour délier les charmes (Warsaw, 1955)',
                    note: 'Rocznik Orientalistyczny XVIII, lxxvi + 498 pages, from a Sorbonne thesis of 1950 supervised by Marcel Cohen. Edition, translation and study of the loosing prayers, and the fundamental work on the Geʿez exorcistic formulary and its structure; its subtitle supplies the genre\'s own name.',
                },
                {
                ...
                },
                {
                    ...
                    note: 'The Ethiopian anaphoras, traditionally fourteen in number and including several composed in Geʿez rather than translated, among them the Anaphora of Our Lady ascribed to Abba Giyorgis of Sägla; the setting into which a person delivered at the holy water is reincorporated, and the reason that reincorporation is the point.',
                },
                {
                    ...
                    note: 'An ethnography of Orthodox life on the Zäge peninsula of Lake Ṭana, attentive to how holy water, fasting and blessing form one connected economy of mediation rather than separate practices.',
                },
                {
                    title: 'Mäṣḥafä Bərhan, of Zärʾa Yaʿəqob',
                    note: 'The fifteenth-century legislation that drew the line between the church\'s authorised use of the divine names and the private practice of the däbtära — and, by the vehemence with which it drew it, showed how blurred the line was.',
                },
            ],
        },
        {
            ...
            paragraphs: [
                ...
                'And travelling in the same manuscripts, often in the same hand, is ዐውደ ነገሥት, the Cycle of Kings. This is not computus but divination. Its core is a set of sixteen circular tables — ʿawd, a circle or round — ruled with Geʿez letters and numerals, each divided into sixteen sections and each named for an Ethiopian lake or river, which is why the book also goes under the name of the Book of Lakes. A question is brought to it under one of a fixed set of headings: a wish, a marriage, a journey, trade and money, an illness, the fate of a ruler. How the tables are actually worked is not set out here. Around this core the manuscripts gather other prognostic matter — the traditions of unlucky days that Ethiopian texts inherit through Coptic and Arabic channels from the late-antique dies aegyptiaci, and the assignment of the hours of day and night to the seven planets in their standard sequence, the planets appearing under Arabic-derived names which are given here in transliteration only, since I could not confirm their Geʿez orthography: Zuḥal for Saturn, Muštäri for Jupiter, Mərriḫ for Mars, Zuhära for Venus, ʿUṭarəd for Mercury. The church has never approved the ʿAwdä Nägäśt and has periodically condemned it, while continuing to teach the ባሕረ ሐሳብ as a monastic accomplishment. The two nonetheless share a codex, a script, a body of arithmetic and frequently a scribe — which is, in the end, the most exact possible picture of what this hall contains: a licit science of time and an illicit one, on the same parchment, in the same hand.',
            ],
            terms: [
                {
                    native: 'ባሕረ ሐሳብ',
                ...
                },
                {
                    ...
                    gloss: 'The Cycle of Kings: a divinatory manual generally traced to Arabic models, built on sixteen circular tables of letters and numerals named for Ethiopian lakes and rivers — whence its other name, the Book of Lakes. Written here with the pharyngeal ʿayn of ʿawd, a circle; Amharic spelling of the title varies. Condemned by the church and copied anyway.',
                },
                {
                    native: 'ጳጉሜን',
                    translit: 'Ṗagumen',
            ...
            texts: [
                {
                    ...
                    note: 'Uriel\'s dictation of the gates of the sun, the phases of the moon and the year of three hundred and sixty-four days, with its denunciation of those who omit the four additional days. The Aramaic version from Qumran (4Q208–4Q211) is longer and more technical; the Geʿez preserves an abridgement.',
                },
                {
                    title: 'Jubilees 6',
                ...
                },
                {
                    ...
                    note: 'The Ethiopian divinatory manual, traced to Arabic models and current in Ethiopia by the later middle ages; sixteen circular tables named for lakes and rivers, consulted on fixed topics, and frequently bound with computistical and devotional texts despite ecclesiastical disapproval. Princeton University Library holds a nineteenth-century set of the sixteen charts. See the entry in the Encyclopaedia Aethiopica.',
                },
                {
                ...
                {
                    title: 'Otto Neugebauer, Ethiopic Astronomy and Computus (Vienna, 1979)',
