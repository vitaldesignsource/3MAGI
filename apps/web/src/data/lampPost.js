export const lampPostCategories = [
    {
        id: 'grimoires',
        label: 'New Discoveries',
        title: 'Manuscripts Newly Surfaced',
        glyph: '✦',
        items: [
            {
                headline: 'The Waziri Book of the Dead Papyrus',
            ...
            {
                headline: 'P.Oxy. 5575: Sayings of Jesus and Thomas',
            ...
            {
                headline: 'The Earliest Infancy Gospel of Thomas Fragment',
            ...
            {
                headline: 'The Newly Published Coptic Magical Papyri',
            ...
            {
                headline: 'Arabic Fragments of Thābit ibn Qurra\'s Book of Talismans',
            ...
            {
                headline: 'The Garden of Souls and the Bridal Chamber',
            ...
            {
                headline: 'New Manuscript Evidence for the Sortes Sanctorum',
            ...
            {
                headline: 'PHerc. 172: A Virtually Unwrapped Herculaneum Scroll',
            ...
            {
                headline: 'Montemonaco Manuscript No. 40 (Speculative)',
    ...
    {
        id: 'auction',
        label: 'Coming to Auction',
        title: 'Rare Books & Objects on the Block',
        glyph: '◈',
        items: [
            {
    ...
    },
    {
        ...
        title: 'The Best Permanent Esoteric Collections',
        glyph: '◫',
        items: [
            {
                headline: 'Museum of Witchcraft and Magic — Boscastle, Cornwall',
                meta: 'Probably the world\'s strongest public museum for the Western occult tradition',
                link: 'https://museumofwitchcraftandmagic.co.uk',
                copy: 'Its collection includes ceremonial swords, wands and pentacles, scrying mirrors and crystals, magical rings and amulets, poppets and curse objects, grimoires and handwritten spell books, objects belonging to Gerald Gardner, the Richel collection of ceremonial regalia, Masonic and Rosicrucian material, and objects connected with Austin Osman Spare, Aleister Crowley and modern occultism. The museum holds thousands of objects and an extensive occult library and archive.',
            },
            {
                headline: 'Embassy of the Free Mind — Amsterdam',
                meta: 'Hermetism, Rosicrucianism, alchemy, Kabbalah, Christian theosophy',
                link: 'https://embassyofthefreemind.com',
                copy: 'Houses the Bibliotheca Philosophica Hermetica collection — rare editions or manuscripts connected with Hermes Trismegistus, Marsilio Ficino, Giordano Bruno, Jacob Böhme, Paracelsus, Robert Fludd, Michael Maier, Heinrich Khunrath, Christian Kabbalah, Rosicrucian manifestos, and alchemical emblem books. Important objects include early editions of the Corpus Hermeticum, Fludd\'s History of the Two Worlds, and Maier\'s Atalanta Fugiens. Booking a rare-book tour is advisable.',
            },
            {
                headline: 'Rosicrucian Egyptian Museum — San Jose, California',
                meta: 'Egyptian religion and a dedicated Rosicrucian Alchemy Exhibition',
                link: 'https://egyptianmuseum.org/alchemy-exhibit',
                copy: 'Alongside its Egyptian collection, the museum has a dedicated Rosicrucian Alchemy Exhibition organized around the seven stages of the Great Work: a full-scale reconstructed alchemist\'s workshop, alchemical manuscripts and imagery, laboratory vessels and apparatus, mineral and metallurgical materials, and a meditation chamber. The presentation makes alchemy intelligible as a complete symbolic, material, and spiritual process.',
            },
            {
                headline: 'Museum of Icelandic Sorcery and Witchcraft — Hólmavík, Iceland',
                meta: 'Seventeenth-century Icelandic magic, staves, and witch trials',
                link: 'https://galdrasyning.is/en/',
                copy: 'Concentrates on seventeenth-century Icelandic magic and the witch trials. Displays concern Icelandic magical staves, historical grimoires, necromantic folklore, protective and harmful galdr, spirit raising, methods for finding thieves, the nábrók or "necropants" tradition, and trial and execution records. Some notorious objects are reconstructions based upon grimoires and folklore; the manuscript and trial material is historical.',
            },
            {
                headline: 'History of Science Museum — Oxford',
                meta: 'Astrology, alchemy, natural magic, and sacred instrumentation',
                link: 'https://www.hsm.ox.ac.uk',
                copy: 'This collection occupies precisely the historical threshold where astrology, alchemy, natural magic, astronomy, and instrumentation had not yet separated. Holdings include astrolabes, armillary spheres, celestial globes, astrological instruments, early chemical apparatus, medieval cosmological models, Islamic astronomical instruments, and Renaissance devices for measuring celestial influence. Particularly relevant to the study of how celestial correspondences were made measurable through metal, geometry, number, and observation.',
            },
            {
                headline: 'Science Museum — London',
                meta: 'Alchemical manuscripts including the six-metre Ripley Scroll',
                copy: 'The archives contain important alchemical manuscripts and apparatus, including a six-metre illustrated Ripley Scroll depicting the creation of the Philosopher\'s Stone. Fragile manuscripts are not necessarily on permanent display; current gallery information should be checked before traveling.',
            },
            {
                headline: 'British Museum — London',
                meta: 'Mesopotamian incantation through Egyptian heka and into Greco-Roman magic',
                link: 'https://www.britishmuseum.org',
                copy: 'Occult material is distributed throughout rather than gathered in one gallery. Collections include Mesopotamian incantation tablets, Egyptian magical wands, protective amulets, Greek and Roman curse tablets, magical gems, divination materials, mummy spells and funerary papyri, astrological objects, and Renaissance magical and alchemical prints. Particularly strong for tracing the historical continuity of magical practice across cultures and centuries.',
            },
            {
                headline: 'Penn Museum — Philadelphia',
                meta: 'Cuneiform incantations, demonological texts, Aramaic incantation bowls',
                link: 'https://www.penn.museum',
                copy: 'Exceptionally strong Mesopotamian and Egyptian collections. Of esoteric importance are cuneiform incantations, demonological texts, protective figurines, divination material, amulets, and Aramaic incantation bowls — inscribed in spirals to trap, repel, or control harmful spiritual beings.',
            },
        ],
    },
    {
        id: 'archaeology',
        label: 'Field Reports',
        title: 'Archaeological Discoveries of Symbolic Weight',
        glyph: '△',
        items: [
            {
        ...
        items: [
            {
                ...
                copy: 'Long before humankind embarked upon its alchemical journey with the metallic realm, the plants were already doing this work. Explore how plants perform many of the same operations found in metallic Alchemy & Spagyria, about the tools that they provide for this work, and the methods of producing true oils of metals, minerals and gemstones using various menstrua. Includes bi-monthly live classes and Q&A sessions, video tutorials, PDFs, community forums and more.',
            },
        ],
    },
    {
        id: 'translations',
        title: 'New Translations of Ancient Texts',
    ...
    },
    {
        id: 'documentaries',
        label: 'Screen & Sound',
        title: 'Esoteric Documentaries Worth Your Evening',
        glyph: '◉',
        items: [
            {
                headline: 'A quiet documentary follows the last apprentices of a dying craft',
                meta: 'Now Streaming',
                copy: 'Filmed over three years, this documentary follows the handful of remaining apprentices trained in a near-extinct method of hand-ground pigment used in sacred manuscript illumination.',
            },
        ],
    },
    {
        ...
        items: [
            {
                ...
                link: 'https://arcaneresearchsociety.com',
            },
            {
                headline: 'An interdisciplinary symposium on hermeticism convenes this fall',
                meta: 'Call for Papers Open',
                copy: 'Scholars of philosophy, art history, and comparative religion will convene this fall for a symposium dedicated to Hermetic transmission across the medieval and early modern periods.',
            },
        ],
    },
    {
        id: 'obituaries',
        label: 'In Memoriam',
        title: 'Notable Deaths in the Community',
        glyph: '⚔',
        items: [
            {
                headline: 'A longtime archivist of regional folk-magic practice is remembered',
                meta: 'In Memoriam',
                copy: 'Colleagues remember a quiet archivist whose decades of fieldwork preserved oral charms and folk remedies that might otherwise have vanished with the last generation to practice them.',
            },
        ],
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                link: 'https://aulalucis.com/product/on-dreams/',
                copy: 'A new translation of Synesius\'s treatise on dreams, exploring the symbolic and visionary dimensions of sleep and the night. Available in Classic Edition (£36.00) and Collector\'s Edition (£77.00).',
            },
            {
                headline: 'On the Eleusinian and Bacchic Mysteries',
                meta: 'Thomas Taylor · Aula Lucis · Presale',
                link: 'https://aulalucis.com/product/on-the-eleusinian-mysteries/',
                copy: 'Thomas Taylor\'s scholarly exploration of the ancient Eleusinian and Bacchic mysteries, their rites, symbolism, and spiritual significance. Available in Classic Edition (£36.00) and Collector\'s Edition (£77.00).',
            },
            {
                headline: 'On Isis and Osiris',
                meta: 'Plutarch · Aula Lucis · Presale',
                link: 'https://aulalucis.com/product/on-isis-and-osiris/',
                copy: 'Plutarch\'s classical account of the Egyptian mysteries of Isis and Osiris, their mythology, ritual significance, and esoteric teachings. Available in Classic Edition (£36.00) and Collector\'s Edition (£77.00).',
            },
            {
                headline: 'A New Light of Alchemy',
                meta: 'Michael Sendivogius · Aula Lucis · Presale',
                link: 'https://aulalucis.com/product/new-light-of-alchemy/',
                copy: 'Michael Sendivogius\'s foundational alchemical treatise, presenting the principles and operations of the Great Work. Available in Classic Edition (£43.00) and Arcanum Edition (£290.00).',
            },
            {
                headline: 'One Is the All: The Alchemical Writings of Cleopatra — forthcoming',
                meta: 'In Preparation · Shannon Grimes & Holden McLennan',
                copy: "Shannon Grimes and Holden McLennan are presently preparing translations of Greek and Latin alchemical and medical texts attributed to Cleopatra the Alchemist — not necessarily the famous Ptolemaic queen, but an enigmatic female authority of Roman Egyptian alchemy. The planned collection is expected to address texts and traditions connected with Hen to Pan ('The One is the All'), alchemical vessels, metallurgical transformation, color changes and tinctures, generation and regeneration, the relationship between womb, vessel and cosmos, and the role of women in early alchemy. This book is still in development, so it should not yet be cited as a completed translation.",
            },
            {
                headline: 'Semesilam: The Eternal Sun',
                meta: 'Anathema Publishing · Multiple Editions',
                link: 'https://www.anathemapublishing.com/books-prints/p/semesilam-the-eternal-sun',
                copy: 'A richly illustrated exploration of solar symbolism and the eternal principle of renewal. Available in Paperback, Standard Hardcover, Collector\'s Edition, and Artisanal Edition formats.',
            },
            {
                headline: 'IAO: Ophite Iconography',
                meta: 'Anathema Publishing · Multiple Editions',
                link: 'https://www.anathemapublishing.com/books-prints/p/iao',
                copy: 'A comprehensive study of the Ophite tradition and the sacred iconography of IAO, exploring Gnostic cosmology and divine imagery through text and illustration.',
            },
            {
                headline: 'Tubelo\'s Forge',
                meta: 'Anathema Publishing · Multiple Editions',
                link: 'https://www.anathemapublishing.com/books-prints/p/tubelos-forge',
                copy: 'A grimoire and practical guide to the forge of Tubelo, the smith-god of witchcraft. Combines historical research with contemporary craft practice.',
            },
            {
                headline: 'The Hanged God',
                meta: 'Anathema Publishing · Multiple Editions',
                link: 'https://www.anathemapublishing.com/books-prints/p/the-hanged-god',
                copy: 'An exploration of the hanged god archetype across Northern European traditions, examining Odin, sacrifice, and the mysteries of suspension and transformation.',
            },
            {
                headline: 'Rod & Ring',
                meta: 'Anathema Publishing · Multiple Editions',
                link: 'https://www.anathemapublishing.com/books-prints/p/rod-and-ring',
                copy: 'A study of phallic and yonic symbolism in Western esotericism, exploring the sacred marriage and the union of opposites across magical traditions.',
            },
        ],
    },
    {
        id: 'media',
        label: 'Signal & Static',
        title: 'New Podcasts & YouTube Channels',
        glyph: '⌘',
        items: [
            {
                headline: 'A new long-form podcast walks through primary alchemical sources',
                meta: 'New Series',
                copy: 'A newly launched podcast dedicates full episodes to single primary sources, reading them aloud alongside historical context rather than summarizing them — a slower, source-first approach worth a subscribe.',
            },
            {
                headline: 'The Foolish Fish',
                meta: 'YouTube Channel · Esoteric Saturdays',
                link: 'https://www.youtube.com/@FoolishFishBooks',
                copy: 'Esoteric Saturdays videos, book overviews and reviews, readings of stories with deeper meaning, and reviews of odd bits and bobs — a channel for the patient reader of strange and curious books.',
            },
            {
                headline: 'Arcanvm',
                meta: 'Podcast · Hosted by Ike Baker',
                link: 'https://www.youtube.com/@arcanvm',
                copy: 'Arcanvm is a channel dedicated to the study of occult philosophy, magic, and the history of the esoteric. Join Ike Baker as he dives deep into the history, theory, and practice of the occult arts and esoteric sciences with some of the foremost experts in the western esoteric tradition, every week. History. Theory. Practice. For the modern occultist.',
                links: [
                    { label: 'patreon.com/arcanvm', url: 'https://www.patreon.com/arcanvm' },
                    { label: 'facebook.com/arcanvvm', url: 'https://www.facebook.com/arcanvvm' },
                    { label: 'ikebaker.com', url: 'https://ikebaker.com' },
                ],
            },
            {
                headline: 'Aetherica',
                meta: 'Podcast · Hosted by Sky Mathis & Ike Baker',
                link: 'https://www.youtube.com/@AETHERICAPODCAST',
                copy: 'Co-hosted by Sky Mathis and Ike Baker, Aetherica ranges across hermeticism, magic, and the philosophical undercurrents of the esoteric current — wide-ranging and unhurried.',
            },
            {
                headline: 'Philosophical Minds',
                meta: 'Podcast',
                link: 'https://www.youtube.com/@philosophicalmindspodcast',
                copy: 'A podcast devoted to philosophy and the life of the mind, drawing threads between classical thought, esoteric philosophy, and the questions that refuse to stay answered.',
            },
            {
                headline: 'The Glitch Bottle',
                meta: 'Podcast',
                link: 'https://www.youtube.com/@glitchbottle',
                copy: 'The Glitch Bottle pours over practical magic, grimoires, and the technical craft of the occult arts — interviews, deep dives, and the occasional unorthodox experiment.',
            },
            {
                headline: 'David Chaim Smith',
                meta: 'Author · Kabbalist · Contemplative',
                link: 'https://www.youtube.com/@LightningFlashofAlef',
                copy: 'David Chaim Smith worked as a visual artist throughout the 1980s. In 1990 he began an immersion into the Hermetic and Hebrew traditions of the Kabbalah, as well as various forms of Alchemy. In 1996 he abandoned visual art for a dedication to spiritual practice and study, from which came a unique blend of practical mysticism and creative innovation. This coalesced as a symbol vocabulary while working with a rare thirteenth-century Kabbalistic text called The Fountain of Wisdom, and served as the basis for his 2006 return to image making, generating the content for several subsequent books including The Kabbalistic Mirror of Genesis, The Sacrificial Universe, The Blazing Dew of Stars, The Awakening Ground, Deep Principles of Kabbalistic Alchemy, Bath of Bright Silence, and The Thirty-Two Keys.',
                links: [
                    { label: 'davidchaimsmith.com', url: 'https://davidchaimsmith.com' },
                    { label: 'thethirtytwokeys.com', url: 'https://thethirtytwokeys.com' },
                ],
            },
            {
                headline: 'The Magician and the Fool',
                meta: 'Podcast',
                link: 'https://www.youtube.com/@themagicianandthefool1878',
                copy: 'A podcast pairing the Magician and the Fool in conversation on magic, esotericism, and the long road between initiation and understanding — equal parts craft and laughter.',
            },
            {
                headline: "Sarah Jane's",
                meta: 'Dream Mysteries · Author & Guide',
                link: 'https://www.youtube.com/@sarahjanesvideos',
                copy: 'Sarah Jane\'s work centers on Dream Mysteries. Her book, Initiation into Dream Mysteries: Drinking from the Pool of Mnemosyne, was published by Inner Traditions in 2022. Enquiries and bookings may be directed to sarahjanes@themysteries.org.',
                links: [
                    { label: 'themysteries.org', url: 'https://themysteries.org' },
                    { label: 'instagram.com/sarahjanesdreaming', url: 'https://www.instagram.com/sarahjanesdreaming' },
                ],
            },
            {
                headline: 'Lifting the Lamp',
                meta: 'Channel · Spiritual Seeker',
                link: 'https://www.youtube.com/@LiftingtheLamp',
                copy: 'Lifting the Lamp is a channel for the spiritual seeker, covering a range of topics including yoga, meditation, manifestation, magick, Kabbalah, Tarot, mysticism, philosophy, the hidden secrets of religion, and the nature of consciousness. It offers practical tips for the spiritual path, as well as the wisdom and life-lessons learned over more than fourteen years of dedicated practice across a number of traditions — a tool to help you on your journey toward awakening, self-realisation, and discovering your potential.',
                links: [
                    { label: 'liftingthelamp.com', url: 'https://liftingthelamp.com' },
                    { label: 'instagram.com/lifting_the_lamp', url: 'https://www.instagram.com/lifting_the_lamp' },
                    { label: 'x.com/liftingthelamp', url: 'https://x.com/liftingthelamp?s=21' },
                ],
            },
            {
                headline: 'Hermetic Podcast',
                meta: 'Podcast · Hermetic Mystery School',
                link: 'https://www.youtube.com/@FraterRC',
                copy: 'The Hermetic Podcast works through Hermetic philosophy and practice with care and precision — a quiet, methodical companion for the dedicated practitioner, drawn from the broader work of the Hermetic Mystery School and its associated circles.',
                links: [
                    { label: 'hermeticpodcast.com', url: 'https://hermeticpodcast.com' },
                    { label: 'hermeticmysteryschool.com', url: 'https://hermeticmysteryschool.com' },
                    { label: 'enochiacon.com', url: 'https://enochiacon.com' },
                    { label: 'arcaneresearchsociety.com', url: 'https://arcaneresearchsociety.com' },
                ],
            },
            {
                headline: 'Aeon Byte Gnostic Radio',
                meta: 'Podcast · Gnosticism & Esotericism',
                link: 'https://www.youtube.com/@AeonByteGnosticRadio',
                copy: 'Aeon Byte Gnostic Radio explores Gnosticism, esotericism, and the hidden teachings of the Western mystery tradition through in-depth interviews and philosophical discourse.',
            },
            {
                headline: 'Hermitix Podcast',
                meta: 'Podcast · Hermetic Philosophy',
                link: 'https://www.youtube.com/@hermitixpodcast',
                copy: 'Hermitix delves into Hermetic philosophy, occult science, and the perennial wisdom traditions with scholarly rigor and practical insight.',
            },
            {
                headline: 'The Astrology Podcast',
                meta: 'Podcast · Astrology & Cosmology',
                link: 'https://www.youtube.com/@theastrologypodcast',
                copy: 'The Astrology Podcast offers comprehensive explorations of astrological theory, practice, and the cosmic patterns that shape human experience.',
            },
            {
                headline: 'Third Eye Drops',
                meta: 'Podcast · Consciousness & Mysticism',
                link: 'https://www.youtube.com/@THIRDEYEDROPS',
                copy: 'Third Eye Drops investigates consciousness, mysticism, and the esoteric dimensions of human experience through conversations with practitioners and scholars.',
            },
            {
                headline: 'The Esoterica Channel',
                meta: 'YouTube Channel · Esoteric History',
                link: 'https://www.youtube.com/@TheEsotericaChannel',
                copy: 'The Esoterica Channel presents scholarly yet accessible explorations of Western esotericism, occult history, and the hidden currents of Western thought.',
            },
            {
                headline: 'Damien Echols',
                meta: 'YouTube Channel · Magick & Spirituality',
                link: 'https://www.youtube.com/@damienechols8091',
                copy: 'Damien Echols, author and practitioner, shares teachings on magick, meditation, and spiritual practice drawn from decades of esoteric study and experience.',
            },
            {
                headline: 'Occult of Personality',
                meta: 'Podcast · Occult Philosophy',
                link: 'https://www.youtube.com/@occultofpersonality',
                copy: 'Occult of Personality features long-form interviews with leading figures in Western esotericism, magic, and occult philosophy, exploring their work and insights.',
            },
            {
                headline: 'The Occult Rejects',
                meta: 'Podcast · Occult Culture',
                link: 'https://www.youtube.com/@theoccultrejects',
                copy: 'The Occult Rejects brings irreverent, in-depth conversations about occultism, magic, and esoteric culture to a community of curious practitioners.',
            },
            {
                headline: 'Embassy of the Free Mind',
                meta: 'YouTube Channel · Hermetic Archive',
                link: 'https://www.youtube.com/@embassyofthefreemind',
                copy: 'The Embassy of the Free Mind, home to the Bibliotheca Philosophica Hermetica, shares rare materials and teachings from one of the world\'s finest esoteric collections.',
            },
            {
                headline: 'M. David Litwa',
                meta: 'YouTube Channel · Hermetic Texts',
                link: 'https://www.youtube.com/@m.davidlitwa',
                copy: 'M. David Litwa, translator of the Hermetica and Hermetic Fragments, shares scholarly insights into ancient Hermetic texts and their contemporary relevance.',
            },
            {
                headline: 'Adam Elenbaas',
                meta: 'YouTube Channel · Astrology & Spirituality',
                link: 'https://www.youtube.com/@adam-elenbaas',
                copy: 'Adam Elenbaas explores astrology, spirituality, and the intersection of cosmic cycles with personal and collective transformation.',
            },
            {
                headline: 'The TLB Podcast',
                meta: 'Podcast · Tarot & Occult',
                link: 'https://www.youtube.com/@thetlbpod',
                copy: 'The TLB Podcast examines tarot, divination, and occult practice through the lens of contemporary spirituality and traditional wisdom.',
            },
            {
                headline: 'Phoenix Aurelius',
                meta: 'YouTube Channel · Hermetic Mastery',
                link: 'https://www.youtube.com/@phoenixaurelius',
                copy: 'Phoenix Aurelius teaches Hermetic principles, meditation, and practical magic for personal transformation and spiritual mastery.',
            },
            {
                headline: 'Institute for Hermetic Studies',
                meta: 'YouTube Channel · Hermetic Education',
                link: 'https://www.youtube.com/@instituteforhermeticstudie7061',
                copy: 'The Institute for Hermetic Studies offers educational content on Hermetic philosophy, sacred geometry, and the Western mystery tradition.',
            },
            {
                headline: 'Lumina Alchemy',
                meta: 'YouTube Channel · Alchemy & Spagyria',
                link: 'https://www.youtube.com/@lumina.alchemy',
                copy: 'Lumina Alchemy shares teachings on botanical alchemy, spagyria, and the transformation of plant and mineral substances through alchemical practice.',
            },
            {
                headline: 'Osirion Podcast',
                meta: 'Podcast · Hosted by Meg Vollmer',
                link: 'https://www.youtube.com/@osirionpodcast',
                copy: 'The Osirion Podcast, hosted by Meg Vollmer, explores esotericism, spirituality, and the mysteries of consciousness through thoughtful conversation.',
            },
            {
                headline: 'Adam McLean',
                meta: 'YouTube Channel · Alchemy & Symbolism',
                link: 'https://www.youtube.com/@adammclean',
                copy: 'Adam McLean, author and alchemical scholar, presents explorations of alchemical symbolism, emblem books, and the history of Western alchemy.',
            },
            {
                headline: 'Alkemix Art',
                meta: 'YouTube Channel · Alchemical Art',
                link: 'https://www.youtube.com/@alkemixart',
                copy: 'Alkemix Art combines visual art, symbolism, and alchemical teaching to explore the intersection of creativity and esoteric practice.',
            },
            {
                headline: 'C.G. Dahlin',
                meta: 'YouTube Channel · Occult Philosophy',
                link: 'https://www.youtube.com/@cgdahlin',
                copy: 'C.G. Dahlin offers scholarly explorations of occult philosophy, Western esotericism, and the hidden dimensions of spiritual practice.',
            },
        ],
    },
    {
        id: 'societies',
        label: 'Whispers',
        title: 'Secret Societies in the News',
        glyph: '★',
        items: [
            {
                headline: 'A regional lodge opens its historical archive to researchers',
                meta: 'Access Granted',
                copy: 'After years of closed-door policy, a regional fraternal lodge has agreed to open portions of its nineteenth-century minute books to vetted academic researchers.',
            },
        ],
    },
    {
        id: 'sightings',
        label: 'Spotted',
        title: 'Symbol Sightings in Architecture & Art',
        glyph: '◈',
        items: [
            {
                headline: 'A hidden alchemical motif noticed in a restored ceiling fresco',
                meta: 'Reader Submission',
                copy: 'Conservation work on a civic ceiling fresco uncovered a small, previously overpainted alchemical motif tucked into a corner medallion — likely the private signature of the original artisan.',
            },
        ],
    },
    {
        id: 'oddities',
        label: 'Curious & Brief',
        title: 'Brief Historical Oddities',
        glyph: '⚖',
        items: [
            {
                headline: 'The bottle buried to catch a witch',
                meta: 'Ritual Protection · Seventeenth Century',
                copy: 'Beneath a London house, archaeologists discovered a seventeenth-century bottle packed with approximately fifty bent pins, rusty nails, and fragments of bone or wood. Such "witch bottles" were concealed to attract harmful magic, trap it, and turn the curse against its sender.',
                link: 'https://www.britannica.com/topic/witch-bottle',
            },
            {
                headline: 'The church that put a corpse on trial',
                meta: 'Ecclesiastical Oddity · 897 CE',
                copy: 'In 897, Pope Formosus was exhumed, dressed in papal vestments, and seated upon a throne to stand trial before his successor. A deacon answered for the dead pontiff, who was convicted, stripped of office, mutilated, and cast into the Tiber.',
                link: 'https://www.britannica.com/biography/Pope-Formosus',
            },
            {
                headline: 'The alchemist who found light in urine',
                meta: 'Alchemical Accident · 1669',
                copy: 'In 1669, Hamburg alchemist Hennig Brand fermented and distilled enormous quantities of urine while searching for the Philosophers\' Stone. Instead, he isolated phosphorus—a substance that appeared to glow with its own cold, mysterious light.',
                link: 'https://www.britannica.com/biography/Hennig-Brand',
            },
            {
                headline: 'The monk who prayed by clockwork',
                meta: 'Mechanical Devotion · Sixteenth Century',
                copy: 'A surviving sixteenth-century automaton depicts a miniature friar powered by key-wound iron machinery hidden inside a wooden body. Once wound, the mechanical monk processes across a table in an uncanny imitation of prayer and penitence.',
                link: 'https://www.metmuseum.org/art/collection/search/466735',
            },
            {
                headline: 'Newton\'s million words of alchemy',
                meta: 'Hidden History · Thirty Years of Study',
                copy: 'Isaac Newton privately pursued alchemy for approximately thirty years, producing or transcribing nearly one million words on the subject. His papers contain laboratory experiments, coded recipes, indexes of substances, and attempts to understand matter\'s hidden transformations.',
                link: 'https://www.newtonproject.ox.ac.uk/',
            },
            {
                headline: 'The woman buried with a sickle at her throat',
                meta: 'Burial Mystery · Seventeenth Century',
                copy: 'In a seventeenth-century Polish cemetery, a young woman was buried with an iron sickle positioned across her neck and a padlock fastened near her foot—ritual restraints apparently intended to prevent the feared dead from rising again.',
                link: 'https://www.smithsonianmag.com/smart-news/archaeologists-find-remains-woman-buried-anti-vampire-precautions-180973758/',
            },
            {
                headline: 'The symbols hidden inside old houses',
                meta: 'Domestic Magic · Medieval to Nineteenth Century',
                copy: 'From the medieval period into the nineteenth century, protective symbols were carved beside doors, windows, fireplaces, and roof beams. These "witch marks"—including hexafoils, pentangles, and Marian signs—were intended to confuse, trap, or repel hostile spirits.',
                link: 'https://www.bbc.com/news/uk-england-beds-bucks-herts-42637779',
            },
            {
                headline: 'When pigs were put on trial',
                meta: 'Legal Oddity · Premodern Europe',
                copy: 'More than two hundred animal trials have been documented in premodern Europe. Pigs, dogs, horses, insects, and other creatures could be formally accused, represented in court, convicted, executed, or placed under ecclesiastical condemnation.',
                link: 'https://www.britannica.com/topic/animal-trial',
            },
            {
                headline: 'When the human body became medicine',
                meta: 'Medical Curiosity · Sixteenth–Seventeenth Centuries',
                copy: 'During the sixteenth and seventeenth centuries, European medicines sometimes contained human blood, fat, bone, and powdered skull. Even royalty consumed such remedies, believing that the body\'s vital spirit remained active within its physical remains.',
                link: 'https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3778611/',
            },
            {
                headline: 'The book bound in human skin',
                meta: 'Bibliographical Oddity · Nineteenth Century',
                copy: 'A nineteenth-century French physician bound a book about the human soul in skin taken without consent from a deceased patient. Scientific testing eventually confirmed its origin; Harvard removed the binding in 2024 and began seeking a respectful disposition.',
                link: 'https://news.harvard.edu/gazette/story/2024/01/harvard-removes-human-skin-binding-from-book/',
            },
        ],
    },
];

export const didYouKnowBoxes = [
    {
        title: 'Did You Know?',
        fact: 'The word "grimoire" descends from the Old French grammaire, originally meaning simply "grammar" — any book of difficult, technical Latin, long before it narrowed to mean a book of spells.',
    },
    {
        title: 'Did You Know?',
        fact: 'Early modern scryers often preferred black mirrors over clear ones specifically because the dimmer reflection was believed to quiet the analytic eye and invite symbolic, rather than literal, perception.',
    },
    {
        title: 'Did You Know?',
        fact: 'Several medieval scriptoria used cipher and abbreviation not for secrecy but for economy — vellum was costly, and a compressed hand could save an entire quire on a long text.',
    },
];
