...
const staticRoutes = [
    ...
    { loc: '/powers',                       priority: '0.9', changefreq: 'monthly' },
    { loc: '/powers/hierarchies',           priority: '0.8', changefreq: 'monthly' },
    { loc: '/powers/host',                  priority: '0.8', changefreq: 'monthly' },
    { loc: '/powers/pantheons',             priority: '0.8', changefreq: 'monthly' },
    { loc: '/powers/daimons',               priority: '0.8', changefreq: 'monthly' },
    { loc: '/powers/texts',                 priority: '0.7', changefreq: 'monthly' },
    { loc: '/powers/map',                   priority: '0.8', changefreq: 'monthly' },
    { loc: '/christianities',               priority: '0.9', changefreq: 'monthly' },
    { loc: '/christianities/christologies', priority: '0.8', changefreq: 'monthly' },
    ...
    { loc: '/third-lamp/education/cuneiform/course', priority: '0.6', changefreq: 'monthly' },
